                ...
                <div class="grid md:grid-cols-2 gap-6 p-4 bg-gray-50 rounded-lg shadow-inner">
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-gray-700">
                            <span class="font-semibold">Main Office:</span> <a href="tel:+1-425-429-7517" class="text-blue-600 hover:text-blue-800 underline block">(425) 429-7517</a>
    ...
    <footer class="bg-white p-6 md:p-10 shadow-inner mt-auto">
        <div class="container mx-auto">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
                ...
                <a href="patient-pay.html" class="block p-4 rounded-xl shadow-md border border-green-200 bg-green-50 text-center transition transform hover:scale-[1.05] hover:shadow-lg duration-300">

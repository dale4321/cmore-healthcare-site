        ...
        <footer class="bg-white p-6 md:p-10 shadow-inner mt-auto">
            <div class="container mx-auto">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
                    ...
                    <a href="about-us.html" class="block p-4 rounded-xl shadow-md border border-green-200 bg-green-50 text-center transition transform hover:scale-[1.05] hover:shadow-lg duration-300">
